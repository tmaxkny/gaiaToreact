    ...
    return (
        <div>
            <Stack sx={{ padding: '24px 32px', width: '100%' }} gap="16px">
                <Typography sx={{ fontSize: '28px', fontWeight: '700', color: '#111928' }}>영수증</Typography>
                <Divider />
                <Typography sx={{ fontSize: '16px', fontWeight: '4 00', color: '#374151' }}>
                    결제일 : 2023-12-31
                </Typography>
            </Stack>
            <Stack sx={{ width: '95%', margin: '0 auto' }} gap="32px">
                <Stack gap="32px" sx={{ borderRadius: '10px', border: '1px solid #D1D5DB' }}>
                    {/* Title */}
                    <Stack
                        direction="row"
                        sx={{
                    ...
                    >
                        <Stack direction="row" gap="8px" alignItems="center">
                            <Receipt style={{ width: '30px', height: '30px', color: '#9CA3AF' }} />
                            <Typography>청구 비용</Typography>
                        </Stack>
                        <Typography sx={{ color: '#1C64F2' }}>₩{RECEIPT_DATA.Price}</Typography>
                    </Stack>
                    {/* 항목들 */}
                    <Stack gap="48px" sx={{ width: '95%', margin: '0 auto', marginBottom: '32px' }}>
                        <Stack gap="24px">
                            {/* <ReceiptItem name={'결제 비용'} value={'30000'} />
                            <ReceiptItem name={'사용 크레딧'} value={'0'} /> */}
                            <Stack direction="row" justifyContent="space-between">
                                <Typography sx={{ fontSize: '18px', fontWeight: '600' }}>{'결제 비용'}</Typography>
                                <Typography sx={{ fontSize: '20px', fontWeight: '500' }}>
                                    -₩{RECEIPT_DATA.PayPrice}
                                </Typography>
                            </Stack>
                            <Stack direction="row" justifyContent="space-between">
                                <Typography sx={{ fontSize: '18px', fontWeight: '600' }}>{'사용 크레딧'}</Typography>
                                <Typography sx={{ fontSize: '20px', fontWeight: '500' }}>
                        ...
                        <Stack gap="24px">
                            ...
                            <Stack direction="row" justifyContent="space-between">
                                <Typography sx={{ fontSize: '18px', fontWeight: '600' }}>{'카드번호'}</Typography>
                                <Typography sx={{ fontSize: '20px', fontWeight: '500' }}>
                                    {RECEIPT_DATA.CardNumber}
                                </Typography>
                            </Stack>
                            <Stack direction="row" justifyContent="space-between">
                                <Typography sx={{ fontSize: '18px', fontWeight: '600' }}>{'카드 소유자'}</Typography>
                                <Typography sx={{ fontSize: '20px', fontWeight: '500' }}>
