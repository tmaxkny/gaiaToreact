...
const SalesDetail: React.FC<any> = React.forwardRef<any, any>(
            ...
            <Stack key={sales.title} sx={{ flex: 1, alignItems: "center" }}>
              ...
              >
                ...
                <Stack direction="row" alignItems="center" sx={{ gap: "4px" }}>
                  ...
                  >
                    <MenuItem value={sales.comparedTo}>
                      {sales.comparedTo}
                    </MenuItem>
                  </Select>
                  <Typography
                  ...
                  >
                    {sales.changedPercentage}% (
                    {sales.changedAmount.toLocaleString()}원)
              ...
              >
                ...
                <Typography sx={{ color: "#1C64F2", fontWeight: "600" }}>
                  {sales.new}
                </Typography>
                <Typography
                  sx={{
